 ...
 * @returns {promise}
 * 
 * @example myPapi.bibSearch('KW=dogs').then(function(response){ });
 * 
 * @example myPapi.bibSearch([['AND','AU','Tolkien'],['NOT','TI','Hobbits']]).then(function(response){ });
 */
